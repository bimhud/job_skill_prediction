...
config = {
    'raw_data_path': BASE_DIR / 'dataset/seek_dataset/dataset.csv',
    'test_path': BASE_DIR / 'dataset/seek_dataset/seek_dataset.valid.pkl',

    'data_dir': BASE_DIR / 'dataset/seek_dataset',
    ...
    'data_label_path': BASE_DIR / "dataset/seek_dataset/skill_list.csv",
